    ...
    return (
        <>
            <div
                ...
                style={
                    props.imp
                        ? { borderTop: "3px solid #dc3545", borderBottom: "3px solid #dc3545" }
                ...
                <div className="Note__max-width p-1">
                    {edit ? (
                            ...
                            <button
                                ...
                                onClick={(_id) => {
                                    if (editTitle.length > 2 && editBody.length > 5) {
                                        props.onEdit(props._id, editTitle, editBody, editImp);
                                        setedit(false);
                        ...
                        <>
                            ...
                            <button
                                type="button"
                                className="btn btn-primary Note__like"
                                onClick={() => {
                                    updateLike(props._id);
                                }}
                            >
                                Like {like ? <AiFillHeart /> : <AiOutlineHeart />}
                                {frontLike}
                            </button>
